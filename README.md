...
##### Uglify-JS Errors
It appears you can ignore uglify-js syntax errors, such as the following or [this one on SO](https://stackoverflow.com/questions/41618989/moonmail-deploy-function-uglify-js-errors), so long as the serverless deployment succeeds.
```
